# Generated by Django 5.0.6 on 2024-12-23 19:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('internship_id', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approval_percentage', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(100)])),
                ('executive', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'SECRETARY'), (2, 'PRESIDENT')], null=True)),
                ('active_key', models.BooleanField(blank=True, default=False, null=True)),
